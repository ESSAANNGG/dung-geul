...
let dtoNumDiv = document.querySelector('#dtoNumDiv');
...
for (let i = 0; i < applyModal.length; i++) {
  applyModal[i].addEventListener('click', () => {
    $('#modalList').empty();
    ...
    let dtoNumInput = document.createElement('input');
    dtoNumInput.setAttribute('id', 'dtoNumInput');
    dtoNumInput.setAttribute('style', 'display:none;');
    dtoNumInput.value = dNum;
    dtoNumDiv.appendChild(dtoNumInput);
