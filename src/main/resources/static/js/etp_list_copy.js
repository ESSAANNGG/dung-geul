...
var applyModal = document.querySelectorAll('.applyModal');
var dtoNum = document.querySelectorAll('.dtoNum');
var dNum, requestURL;
  ...
  applyModal[i].addEventListener('click', () => {
    ...
    function apply(jsonObj) {
      ...
      for (var j = 0; j < applys.length; j++) {
        ...
        var userId = applys[j].user_id;
        var introNum = applys[j].intro_num;
