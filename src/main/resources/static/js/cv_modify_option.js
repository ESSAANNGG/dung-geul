...
$(document).ready(function () {
  ...
  $('#add_lic').click(function (e) {
    lic_name++;
    $('.line_lic').before(
      '<div class="item_lic">          <div class="info">           <!-- body overlay -->           <div class="body-blackout"></div>           <!-- Modals Triggers -->                      <!-- Modals -->           <div class="popup-modal shadow" data-popup-modal="one">            <i class="fa fa-window-close popup-modal__close"></i>            <h1 class="font-weight-bold">자격증 불러오기</h1>            <div>             <div class="layer_manage_wrap" style="margin-top: 20px">              <div class="resume_data">               <div>                <div class="title_wrap" style="margin: 10px 0 3px 0">                 <!-- COUNT --><strong class="attach_count">총 <span>2</span>건</strong>                </div>                <div class="table_scroll">                 <table class="manage_list_table">                  <caption>                   자격증 리스트                  </caption>                  <colgroup>                   <col width="58" />                   <col width="140" />                   <col />                   <col width="140" />                  </colgroup>                  <thead>                   <tr>                    <th scope="col">                     <span class="inpChk">                      <input type="checkbox" name="import_all_check"                       id="import_all_check_1623578366378" />                      <label class="lbl hide" for="import_all_check_1623578366378">전체선택</label>                     </span>                    </th>                    <th scope="col">취득일</th>                    <th scope="col">자격증명</th>                    <th scope="col">만료일</th>                   </tr>                  </thead>                  <tbody>                   <!-- LIST -->                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161003_1623578366378" /><label class="lbl hide"                       for="import_2161003_1623578366378"></label></span>                    </td>                    <td>2021.08</td>                    <td>컴퓨터그래픽스운용기능사</td>                    <td>2021.08</td>                   </tr>                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161002_1623578366378" /><label class="lbl hide"                       for="import_2161002_1623578366378"></label></span>                    </td>                    <td>2021.07</td>                    <td>컴퓨터활용능력2급</td>                    <td>2021.08</td>                   </tr>                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161002_1623578366378" /><label class="lbl hide"                       for="import_2161002_1623578366378"></label></span>                    </td>                    <td>2021.07</td>                    <td>컴퓨터활용능력2급</td>                    <td>2021.08</td>                   </tr>                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161002_1623578366378" /><label class="lbl hide"                       for="import_2161002_1623578366378"></label></span>                    </td>                    <td>2021.07</td>                    <td>컴퓨터활용능력2급</td>                    <td>2021.08</td>                   </tr>                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161002_1623578366378" /><label class="lbl hide"                       for="import_2161002_1623578366378"></label></span>                    </td>                    <td>2021.07</td>                    <td>컴퓨터활용능력2급</td>                    <td>2021.08</td>                   </tr>                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161002_1623578366378" /><label class="lbl hide"                       for="import_2161002_1623578366378"></label></span>                    </td>                    <td>2021.07</td>                    <td>컴퓨터활용능력2급</td>                    <td>2021.08</td>                   </tr>                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161002_1623578366378" /><label class="lbl hide"                       for="import_2161002_1623578366378"></label></span>                    </td>                    <td>2021.07</td>                    <td>컴퓨터활용능력2급</td>                    <td>2021.08</td>                   </tr>                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161002_1623578366378" /><label class="lbl hide"                       for="import_2161002_1623578366378"></label></span>                    </td>                    <td>2021.07</td>                    <td>컴퓨터활용능력2급</td>                    <td>2021.08</td>                   </tr>                   <tr>                    <td>                     <span class="inpChk"><input type="checkbox" name="import_check"                       id="import_2161002_1623578366378" /><label class="lbl hide"                       for="import_2161002_1623578366378"></label></span>                    </td>                    <td>2021.07</td>                    <td>컴퓨터활용능력2급</td>                    <td>2021.08</td>                   </tr>                  </tbody>                 </table>                </div>               </div>              </div>              <div class="bottom_btn_wrap">               <button type="button" class="btn_confirm">불러오기</button>              </div>             </div>            </div>           </div>                      <div class="common_div width-430">            <label class="absolute-label" for="">자격증 명 </label>            <input class="common_input" type="text" name="certificate[][lic_name]" />           </div>           <div class="common_div width-180">            <label class="absolute-label" for="">취득일 </label>            <input class="common_input" type="date" name="certificate[][lic_date]" />           </div>           <div class="common_div width-180">            <label class="absolute-label" for="">만료일 </label>            <input class="common_input" type="date" name="certificate[][lic_due_date]" />           </div>           <button type="button" class="btn btn-sm btn-primary popup-trigger" style="margin-left:10px; vertical-align: top;">자격증 불러오기</button>          </div>         </div>  '
    );
    lic_number++;
    if (lic_number > 0) {
