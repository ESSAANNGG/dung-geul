  ...
  save: function () {
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        var dtoNum = document.querySelector('.listNum');
        var dNum, requestURL;

        $('#modalList').empty();

        dNum = dtoNum.innerHTML;

        requestURL = '/application/etp/employ/list/' + dNum;
        ...
        function apply(jsonObj) {
          var applys = jsonObj['dtoList'];

          for (var j = 0; j < applys.length; j++) {
            var myTr = document.createElement('tr');
            modalList.appendChild(myTr);

            var checkTh = document.createElement('td');
            var nameTh = document.createElement('td');
            var cvTh = document.createElement('td');
            var introTh = document.createElement('td');
            var areaTh = document.createElement('td');
            var taskTh = document.createElement('td');
        ...
        var listSuccessfulApplicants = document.querySelector('#listSuccessfulApplicants');
        var dtoNum2 = document.querySelector('.listNum');
        var dNum2, requestURL2;

        $('#listSuccessfulApplicants').empty();

        dNum2 = dtoNum2.innerHTML;

        // 바뀔 수 있음
        requestURL2 = '추후에 추가' + dNum2;
        ...
        function applyPass(jsonObj2) {
          var applysPass = jsonObj2['dtoList'];

          for (var j = 0; j < applysPass.length; j++) {
            var myTr = document.createElement('tr');
  ...
  save: function () {
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        var listRejectedCandidates = document.querySelector('#listRejectedCandidates');
        var dtoNum3 = document.querySelector('.listNum');
        var dNum3, requestURL3;

        $('#listRejectedCandidates').empty();

        dNum3 = dtoNum3.innerHTML;

        // 바뀔 수 있음
        requestURL3 = '추후에 추가' + dNum3;

        var request3 = new XMLHttpRequest();
        request3.open('GET', requestURL2);
        ...
        function applyFail(jsonObj3) {
          var applysFail = jsonObj3['dtoList'];

          for (var j = 0; j < applysFail.length; j++) {
            var myTr = document.createElement('tr');
