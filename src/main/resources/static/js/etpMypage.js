            ...
            preFilter: {
              ...
              PSEUDO: function (e) {
                ...
                return Q.CHILD.test(e[0])
                  ? null
                  : (e[3] && e[4] !== t ? (e[2] = e[4]) : r && J.test(r) && (n = mt(r, !0)) && (n = r.indexOf(')', r.length - n) - r.length) && ((e[0] = e[0].slice(0, n)), (e[2] = r.slice(0, n))),
                    e.slice(0, 3));
              },
            },
            filter: {
  ...
  x.each(
    ...
    function (e, t) {
      x.fn[e] = function (n, r) {
        ...
        return (
          'Until' !== e.slice(-5) && (r = n), r && 'string' == typeof r && (i = x.filter(r, i)), this.length > 1 && (ct[e] || (i = x.unique(i)), lt.test(e) && (i = i.reverse())), this.pushStack(i)
        );
      };
    }
  ),
      ...
      this.each(function () {
        ...
        function C() {
          window.addEventListener
            ? (this.addEventListener('DOMMouseScroll', r, !1), this.addEventListener('mousewheel', r, !1), this.addEventListener('MozMousePixelScroll', r, !1))
