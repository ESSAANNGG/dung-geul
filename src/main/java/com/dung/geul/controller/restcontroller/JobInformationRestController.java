...
public class JobInformationRestController { // 진로설계 - 직업정보, 사전 검색
    ...
    @PostMapping("/jobsearch_k")    // 직업 정보 조회(키워드 검색)
    public String jobsearch_k(String searchCode) {
        ...
        StringBuffer result = new StringBuffer();
        try {
            String apiUrl = "http://openapi.work.go.kr/opi/opi/opia/jobSrch.do?authKey=" +
                    authKey +
                    "&returnType=XML&target=JOBCD&keyword=" +
                    searchCode;
