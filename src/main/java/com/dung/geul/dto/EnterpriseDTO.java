...
public class EnterpriseDTO extends MemberDTO {
   ...
   private String etp_sector; // 업종
    ...
    public EnterpriseDTO(String user_id, String user_name, String user_pw,
                         String user_ph, String user_postcode, String user_addr,
                         String user_addr_details, String user_email, String user_dept,
                         String user_grade, String user_class, String user_job, String role,
        ...
        super(user_id, user_name, user_pw, user_ph, user_postcode, user_addr, user_addr_details,
                user_email, user_dept, user_grade, user_class, user_job, role);
